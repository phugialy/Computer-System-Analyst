@echo off
echo ========================================
echo Computer Inspector - Working Build
echo ========================================
echo.
...
REM Build with GPUtil excluded
echo.
echo [6/6] Building executable (GPUtil excluded)...
echo Using compatible build configuration...
...
echo.
echo Note: GPU detection will use PowerShell instead of GPUtil
